...
insert into permission_type (id, description, name) values (1, 'descrição', 'admin');
...
insert into permission_group (id, name) values (1, 'admin');

insert into permission_group_permission_type (permission_group_id, permission_type_id) values (1, 1);

insert into user (id, name, email, password, created_at) values (1, 'Peter Clayder', 'peter@gmail.com', '123', utc_timestamp);

insert into user_permission_group (user_id, permission_group_id) values (1, 1);